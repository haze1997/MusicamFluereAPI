public class CardService
{
    ...
    private void SeedData()
    {
        _cards.AddRange(new List<Card>
        {
            ...
            {
                Id = Guid.NewGuid(),
                Title = "Implementar endpoints da API",
            ...
            {
                Id = Guid.NewGuid(),
                Title = "Criar tela do Scrum Board",
                Description = "Desenvolver o frontend com as colunas do quadro Kanban",
                Assignee = "Pedro",
                Priority = "Medium",
                Status = "Backlog",
            ...
            new()
            {
                ...
                Description = "Documentar todos os endpoints no README do projeto",
                Assignee = "Ana",
                Priority = "Low",
                Status = "Backlog",
